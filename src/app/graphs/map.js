...
import Data1 from "../dataset/thirdGraphData1.json";
import Data2 from "../dataset//thirdGraphData2.json";
import Data3 from "../dataset//thirdGraphData3.json";
import Data4 from "../dataset//thirdGraphData4.json";
import Data5 from "../dataset//thirdGraphData5.json";
import Data6 from "../dataset//thirdGraphData6.json";
...
const AllCircles = () => {
  return Data.map((item) => <MetaCircle arr={item} />);
};

const center = [41.9, -87.624];
...
const Map = () => {
  ...
  return (
    <>
      ...
      <button style={leftStyle} onClick={handleDecrease}>
        &#60;
      </button>
      <h7 style={textStyle}>{GetTime(value)}</h7>
      <button style={rightStyle} onClick={handleIncrease}>
        {" "}
        &#62;{" "}
      </button>
    </>
